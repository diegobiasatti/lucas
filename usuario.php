...
/*if ($_SERVER['REQUEST_METHOD'] == 'POST') 
{
	...
	$response = new usuarioController();
	$logueo	 = $response->login($nombre, $password);
	$respuesta = $logueo['mensaje'];

	if ($respuesta === "OK")
	{
		$usuario = $response->datosUsuario($logueo['id']);
		$bienvenida = "Bienvenido/a  " . strtoupper($nombre);
	}
	else
	{	
		$bienvenida = $logueo['mensaje'];
	...
	<div>
		...
		<div class="row">
			...
			<table class="table table-bordered table-striped">
				<?php $cantidad = 1; foreach ($userDetails as $key => $value) { ?>
